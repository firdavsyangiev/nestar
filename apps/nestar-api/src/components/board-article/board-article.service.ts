...
export class BoardArticleService {
	...
	public async updateBoardArticle(memberId: ObjectId, input: BoardArticleUpdate): Promise<BoardArticle> {
		...
		const result = await this.boardArticleModel
			.findOneAndUpdate({ _id, memberId: memberId, articleStatus: BoardArticleStatus.ACTIVE }, input, {
				new: true,
			})
			.exec();
	...
	public async likeTargetBoardArticle(memberId: ObjectId, likeRefId: ObjectId): Promise<BoardArticle> {
		...
		// LIKE TOGGLE via LikeService module
	...
	public async updateBoardArticleByAdmin(input: BoardArticleUpdate): Promise<BoardArticle> {
		...
		const result = await this.boardArticleModel
			.findOneAndUpdate({ _id, articleStatus: BoardArticleStatus.ACTIVE }, input, {
				new: true,
			})
			.exec();
	...
	public async removeBoardArticleByAdmin(articleId: ObjectId): Promise<BoardArticle> {
		...
		const result = await this.boardArticleModel.findOneAndDelete(search);
